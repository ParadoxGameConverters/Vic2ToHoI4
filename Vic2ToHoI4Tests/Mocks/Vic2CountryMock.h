#ifndef VIC2_COUNTRY_MOCK
#define VIC2_COUNTRY_MOCK
...
class mockVic2Country final: public Vic2::Country
{
  public:
	...
	MOCK_METHOD(std::optional<const Vic2::Party>,
		 getRulingParty,
	...
	MOCK_METHOD(activeParties, getActiveParties, (const std::vector<Vic2::Party>& allParties), (const, override));
