...
class HoI4Localisation
{
  public:
	...
	{
		getInstance()->AddStateLocalisation(hoi4State, vic2State, theStateDefinitions);
	}

	static void addStateLocalisations(const HoI4::States& states) { getInstance()->AddStateLocalisations(states); }
