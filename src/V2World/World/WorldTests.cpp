...
{
	const commonItems::ModFilesystem mod_filesystem(std::filesystem::path("BlankWorld"), {});
	const auto world =
...
{
	const commonItems::ModFilesystem mod_filesystem(std::filesystem::path("MergeWorld"), {});
	const auto world =
		 Vic2::World::Factory(mod_filesystem, 0.0F)
			  .importWorld(
