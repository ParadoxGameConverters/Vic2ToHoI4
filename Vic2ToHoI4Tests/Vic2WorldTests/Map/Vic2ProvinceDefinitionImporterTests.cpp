...
{
	EXPECT_THROW(Vic2::importProvinceDefinitions("", {}), std::runtime_error);
}
...
TEST(Vic2World_Map_Vic2ProvinceDefinitionImporterTests, LandProvincesCanBeDetermined)
{
	const auto definitions =
		 Vic2::importProvinceDefinitions("V2World", {{1, Vic2::Province::Builder{}.setNumber(1).setIsLand().build()}});
...
{
	const auto definitions =
		 Vic2::importProvinceDefinitions("V2World", {{1, Vic2::Province::Builder{}.setNumber(1).build()}});
