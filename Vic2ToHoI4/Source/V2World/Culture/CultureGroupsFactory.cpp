...
Vic2::CultureGroups::Factory::Factory()
{
	registerRegex(commonItems::catchallRegex, [this](const std::string& groupName, std::istream& theStream) {
		...
		for (const auto& culture: cultureGroupFactory.getCultureGroup(theStream))
		{
			...
			{
				//North Americans
				if (culture == "central_algonquian" || culture == "cherokee" || culture == "cree" || culture == "dakota" || culture == "eastern_algonquian" || culture == "eskaleut" ||
					culture == "inuit" || culture == "iroquoian" || culture == "metis" || culture == "navajo" || culture == "penutian" || culture == "plains_algonquian"||
					culture == "pueblo"  || culture == "siouan"  || culture == "native_american_minor")
					cultureGroups->mappings.insert(make_pair(culture, "native_north_american"));
				//Central Americans
				else if (culture == "chibchan" || culture == "mayan" || culture == "nahua" || culture == "sonoran" || culture == "tarascan" || culture == "zapotec")
					cultureGroups->mappings.insert(make_pair(culture, "native_central_american"));
				//South Americans
				else if (culture == "aimara" || culture == "amazonian" || culture == "araucanian" || culture == "caddoan" || culture == "chacoan" || culture == "guajiro" ||
					culture == "guarani" || culture == "je" || culture == "maranon" || culture == "muskogean" || culture == "na_dene" || culture == "patagonian" || culture == "quechua" ||
					culture == "tupinamba")
