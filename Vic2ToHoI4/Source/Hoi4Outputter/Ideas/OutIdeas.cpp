...
void outputIdeologicalIdeas(const std::map<std::string, HoI4::IdeaGroup>& ideologicalIdeas, const std::set<std::string>& majorIdeologies, const Configuration& theConfiguration);
void outputGeneralIdeas(const std::vector<std::unique_ptr<HoI4::IdeaGroup>>& generalIdeas, const Configuration& theConfiguration);
void HoI4::outIdeas(const Ideas& ideas, const std::set<std::string>& majorIdeologies, const Configuration& theConfiguration)
{
