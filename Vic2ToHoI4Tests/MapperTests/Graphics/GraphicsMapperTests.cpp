...
{
	EXPECT_TRUE(graphicsMapper->getArmyPortraits("nonexistent_culture_group").empty());
}
...
{
	EXPECT_TRUE(graphicsMapper->getNavyPortraits("nonexistent_culture_group").empty());
}
...
{
	EXPECT_TRUE(graphicsMapper->getMaleMonarchPortraits("nonexistent_culture_group").empty());
}
...
{
	EXPECT_TRUE(graphicsMapper->getFemaleMonarchPortraits("nonexistent_culture_group").empty());
}
...
{
	EXPECT_EQ("gfx/leader_unknown.dds", graphicsMapper->getLeaderPortrait("nonexistent_culture_group", "good_ideology"));
	EXPECT_EQ("gfx/leader_unknown.dds", graphicsMapper->getLeaderPortrait("test_culture_group", "missing_ideology"));
}
...
{
	EXPECT_TRUE(graphicsMapper->getMaleOperativePortraits("nonexistent_culture_group").empty());
}
...
{
	EXPECT_TRUE(graphicsMapper->getFemaleOperativePortraits("nonexistent_culture_group").empty());
}
...
{
	EXPECT_EQ(std::nullopt, graphicsMapper->getGraphicalCulture("nonexistent_culture_group"));
}
...
{
	EXPECT_EQ(std::nullopt, graphicsMapper->get2dGraphicalCulture("nonexistent_culture_group"));
}
