	 ...
	 const std::set<std::string>& majorIdeologies)
{
	...
	capitulationEvents[0].clearDescriptions();
	...
	positiveCollaborationDifferentIdeology << "\t\t}\n";
	positiveCollaborationDifferentIdeology << "\t}\n";
	capitulationEvents[0].giveDescription(positiveCollaborationDifferentIdeology.str());
	...
	positiveCollaborationInvadedSameIdeology << "\t\t}\n";
	positiveCollaborationInvadedSameIdeology << "\t}\n";
	capitulationEvents[0].giveDescription(positiveCollaborationInvadedSameIdeology.str());
	...
	positiveBothNoFaction << "\t\t}\n";
	positiveBothNoFaction << "\t}\n";
	capitulationEvents[0].giveDescription(positiveBothNoFaction.str());
	...
	positivePrevNoFaction << "\t\t}\n";
	positivePrevNoFaction << "\t}\n";
	capitulationEvents[0].giveDescription(positivePrevNoFaction.str());
	...
	positivePrevFaction << "\t\t}\n";
	positivePrevFaction << "\t}\n";
	capitulationEvents[0].giveDescription(positivePrevFaction.str());
	...
	negativeCollaborationDifferentIdeology << "\t\t}\n";
	negativeCollaborationDifferentIdeology << "\t}\n";
	capitulationEvents[0].giveDescription(negativeCollaborationDifferentIdeology.str());
	...
	negativeBothNoFaction << "\t\t}\n";
	negativeBothNoFaction << "\t}\n";
	capitulationEvents[0].giveDescription(negativeBothNoFaction.str());
	...
	negativePrevNoFaction << "\t\t}\n";
	negativePrevNoFaction << "\t}\n";
	capitulationEvents[0].giveDescription(negativePrevNoFaction.str());
	...
	negativePrevFaction << "\t\t}\n";
	negativePrevFaction << "\t}\n";
	capitulationEvents[0].giveDescription(negativePrevFaction.str());
	...
	neutralBothNoFaction << "\t\t}\n";
	neutralBothNoFaction << "\t}\n";
	capitulationEvents[0].giveDescription(neutralBothNoFaction.str());
	...
	neutralPrevNoFaction << "\t\t}\n";
	neutralPrevNoFaction << "\t}\n";
	capitulationEvents[0].giveDescription(neutralPrevNoFaction.str());
	...
	neutralPrevFaction << "\t\t}\n";
	neutralPrevFaction << "\t}\n";
	capitulationEvents[0].giveDescription(neutralPrevFaction.str());
}