...
cp "Vic2ToHoI4/Data_Files/configuration.txt" "Release-Linux/configuration.txt"
cp "Vic2ToHoI4/Data_Files/configuration.txt" "Release-Linux/configuration-example.txt"
...
cp "Vic2ToHoI4/Data_Files/HPM_province_mappings.txt" "Release-Linux/HPM_province_mappings.txt"
...
cp "Vic2ToHoI4/Data_Files/names.txt" "Release-Linux/names.txt"
...
cp "Vic2ToHoI4/Data_Files/Resources.txt" "Release-Linux/resources.txt"
cp "Vic2ToHoI4/Data_Files/shipTypes.txt" "Release-Linux/shipTypes.txt"
cp "Vic2ToHoI4/Data_Files/tech_mapping.txt" "Release-Linux/tech_mapping.txt"
cp "Vic2ToHoI4/Data_Files/unit_mappings.txt" "Release-Linux/unit_mappings.txt"
cp "Vic2ToHoI4/Data_Files/version.txt" "Release-Linux/DataFiles/version.txt"
cp "Vic2ToHoI4/Data_Files/Vic2Localisations.csv" "Release-Linux/DataFilesVic2Localisations.csv"
